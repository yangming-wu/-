<?php /*a:1:{s:62:"C:\wamp64\www\tumor\application\admin\view\clinical\index.html";i:1583913397;}*/ ?>
<!DOCTYPE html>
<html>
  ...
  <body>
    <div class="x-nav">
      <span class="layui-breadcrumb">
        <a href="/tumor/uploads/demo/LT_Clinicaltrial.xls" download="LT_Clinicaltrial" target="__blank">示例数据表下载</a>
      </span>
    ...
    <div class="x-body">
      ...
      <xblock>
        ...
        <div class="x-right" style="width:30%;position: relative;">
          <form action="<?php echo url('/admin/clinicaltrial'); ?>" method="GET">
      ...
      <table class="layui-table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><?php echo htmlentities($item['variant_type']); ?></td>
            <td><?php echo htmlentities($item['gene']); ?></td>
            <td><?php echo htmlentities($item['chgvs']); ?></td>
            <td><?php echo htmlentities($item['phgvs']); ?></td>
            <td><?php echo htmlentities($item['cancer_type']); ?></td>
            <td><?php echo htmlentities($item['cancer_subtype']); ?></td>
            <td><?php echo htmlentities($item['clin_drug']); ?></td>
            <td><?php echo htmlentities($item['clinicaltrial_id']); ?></td>
            <td class="td-manage">
            <button class="layui-btn layui-btn-normal layui-btn-sm" onclick="x_admin_show('编辑','<?php echo url('/admin/clinicaltrial/'); ?>' + '<?php echo htmlentities($item['id']); ?>/edit')">编辑</button>
...
layui.use('upload', function(){
  ...
  let url = "<?php echo url('/admin/clinicaltrial/upload'); ?>";
  //指定允许上传的文件类型
  upload.render({
    elem: '#uploadFile',
    url,
...
<script>
  ...
  function delAll (argument){
    ...
    let url = "<?php echo url('/admin/clinicaltrial/delAll'); ?>"
    // console.log(url)
