<?php /*a:1:{s:67:"C:\wamp64\www\tumor\application\admin\view\drug_approval\index.html";i:1583918991;}*/ ?>
<!DOCTYPE html>
<html>
  ...
  <body>
    <div class="x-nav">
      <span class="layui-breadcrumb">
        <a href="/tumor/uploads/demo/LT_Approval.xls" download="LT_Approval.xls" target="__blank">示例数据表下载</a>
      </span>
    ...
    <div class="x-body">
      ...
      <xblock>
        ...
        <div class="x-right" style="width:30%;position: relative;">
          <form action="<?php echo url('/admin/approval'); ?>" method="GET">
      ...
      <table class="layui-table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><?php echo htmlentities($item['drug']); ?></td>
            <td><?php echo htmlentities($item['fda_nccn']); ?></td>
            <td><?php echo htmlentities($item['cfda']); ?></td>
            <td class="td-manage">
              <button class="layui-btn layui-btn-normal layui-btn-sm" onclick="x_admin_show('编辑','<?php echo url('/admin/approval/'); ?>' + '<?php echo htmlentities($item['id']); ?>/edit')">编辑</button>
...
layui.use('upload', function(){
  ...
  let url = "<?php echo url('/admin/approval/upload'); ?>";
  //指定允许上传的文件类型
  upload.render({
    elem: '#uploadFile',
    url,
...
<script>
  ...
  function delAll (argument){
    ...
    let url = "<?php echo url('/admin/approval/delAll'); ?>"
    // console.log(url)
