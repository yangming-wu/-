<?php /*a:1:{s:60:"C:\wamp64\www\tumor\application\admin\view\immuno\index.html";i:1583910210;}*/ ?>
<!DOCTYPE html>
<html>
  ...
  <body>
    <div class="x-nav">
      <span class="layui-breadcrumb">
        <a href="/tumor/uploads/demo/LT_Immunotherapy.xls" download="LT_Immunotherapy" target="__blank">示例数据表下载</a>
      </span>
    ...
    <div class="x-body">
      ...
      <xblock>
        ...
        <div class="x-right" style="width:30%;position: relative;">
          <form action="<?php echo url('/admin/immunotherapy'); ?>" method="GET">
      ...
      <table class="layui-table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><?php echo htmlentities($item['biomaker']); ?></td>
            <td><?php echo htmlentities($item['nccn_drug']); ?></td>
            <td class="td-manage">
              <button class="layui-btn layui-btn-normal layui-btn-sm" onclick="x_admin_show('编辑','<?php echo url('/admin/immunotherapy/'); ?>'+ '<?php echo htmlentities($item['id']); ?>/edit')">编辑</button>
...
layui.use('upload', function(){
  ...
  let url = "<?php echo url('/admin/immunotherapy/upload'); ?>";
  //指定允许上传的文件类型
  upload.render({
    elem: '#uploadFile',
    url,
...
<script>
  ...
  function delAll (argument){
    ...
    let url = "<?php echo url('/admin/immunotherapy/delAll'); ?>"
    // console.log(url)
