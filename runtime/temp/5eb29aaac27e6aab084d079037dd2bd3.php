<?php /*a:1:{s:62:"C:\wamp64\www\tumor\application\admin\view\immother\index.html";i:1583910162;}*/ ?>
<!DOCTYPE html>
<html>
  ...
  <body>
    <div class="x-nav">
      <span class="layui-breadcrumb">
        <a href="/tumor/uploads/demo/LT_immune_other.xls" download="LT_immune_other" target="__blank">示例数据表下载</a>
      </span>
    ...
    <div class="x-body">
      ...
      <xblock>
        ...
        <div class="x-right" style="width:30%;position: relative;">
          <form action="<?php echo url('/admin/immuno_other'); ?>" method="GET">
      ...
      <table class="layui-table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><?php echo htmlentities($item['biomarker']); ?></td>
            <td><?php echo htmlentities($item['correlation']); ?></td>
            <td class="td-manage">
              <button class="layui-btn layui-btn-normal layui-btn-sm" onclick="x_admin_show('编辑','<?php echo url('/admin/immuno_other/'); ?>'+ '<?php echo htmlentities($item['id']); ?>/edit')">编辑</button>
...
layui.use('upload', function(){
  ...
  let url = "<?php echo url('/admin/immuno_other/upload'); ?>";
  //指定允许上传的文件类型
  upload.render({
    elem: '#uploadFile',
    url,
...
<script>
  ...
  function delAll (argument){
    ...
    let url = "<?php echo url('/admin/immuno_other/delAll'); ?>"
    // console.log(url)
